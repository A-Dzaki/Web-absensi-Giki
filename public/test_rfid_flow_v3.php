...
echo "<h1>Test RFID Flow V3 (Time Fixed)</h1>";
...
echo "Today is: $hariIndo | Time: " . now()->format('H:i:s') . "<br>";
...
if (!$jadwalForToday) {
    ...
    $jadwalForToday->jam_mulai = '00:00:00'; // Make it cover everything
    $jadwalForToday->jam_selesai = '23:59:59';
    ...
    // Update existing schedule to cover current time
    echo "Updating existing schedule '{$jadwalForToday->mata_pelajaran}' to cover now...<br>";
    $jadwalForToday->jam_mulai = '00:00:00';
    $jadwalForToday->jam_selesai = '23:59:59';
    $jadwalForToday->save();
}
